...
!----------------------------------------------------------------------------------------------------  
   ...
   INTEGER, SAVE                  :: UnWind   = 91          ! The unit number used for wind inflow files
...
!----------------------------------------------------------------------------------------------------  
   ...
   IF ( WindType /= Undef_Wind ) THEN 
    ! Yang: not write information in FAST2AQWA interface
...
!----------------------------------------------------------------------------------------------------
   ...
   SELECT CASE ( TRIM(FileNameEnd) )
      ...
      ! Yang: Not write these information when coupling with AQWA   
